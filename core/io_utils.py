...
def atomic_write_file(
    ...
    Enforces output path safety validation (rejects None, empty strings, and null bytes).
    ...
    """
    # Defensive path validation: reject invalid, empty, or null-byte containing output paths
    safe_file_path = validate_safe_output_path(file_path, param_name="file_path")
    abs_path = os.path.abspath(safe_file_path)
